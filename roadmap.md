...
| **TabControl** | Вкладки | Средний | ✅ Готово |
| **Treeview** | Дерево с вложенностью | Средний | ✅ Готово |
| **Tooltip** | Всплывающая подсказка | Средний | ✅ Готово |
| **Menu / ContextMenu** | Контекстное меню | Средний | ✅ Готово |
| **Dialog / MessageBox** | Модальное диалоговое окно | Средний | ✅ Готово |
